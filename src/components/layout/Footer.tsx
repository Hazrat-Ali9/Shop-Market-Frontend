        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your premier destination for fashion. Discover the latest trends and timeless classics with secure shopping and fast delivery.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/men" className="text-gray-400 hover:text-white transition-colors">Men's Fashion</Link></li>
              <li><Link to="/women" className="text-gray-400 hover:text-white transition-colors">Women's Fashion</Link></li>
